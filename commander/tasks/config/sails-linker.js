	...
	grunt.config.set('sails-linker', {
		devJs: {
			...
			files: {
				...
				'views/**/*.dust': require('../pipeline').jsFilesToInject
			}
		},
		...
		prodJs: {
			...
			files: {
				...
				'views/**/*.dust': ['.tmp/public/min/production.min.js']
			}
		},
		...
		devStyles: {
			...
			files: {
				...
				'views/**/*.dust': require('../pipeline').cssFilesToInject
			}
		},
		...
		prodStyles: {
			...
			files: {
				...
				'views/**/*.dust': ['.tmp/public/min/production.min.css']
			}
		},
