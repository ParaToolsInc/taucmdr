...
tau application create "ex-mm-mpi" --mpi
...
tau project create "ex-mm" localhost ex-mm-serial ex-mm-openmp ex-mm-mpi ex-mm-openmp-mpi ex-profile ex-trace ex-sample
tau project select ex-mm ex-mm-mpi ex-profile
